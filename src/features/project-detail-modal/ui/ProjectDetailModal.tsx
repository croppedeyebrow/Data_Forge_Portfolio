  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="glass-card rounded-3xl p-8 m-4">
          {/* 헤더 */}
          <div className="flex items-start justify-between mb-8">
            ...
            <Button
              onClick={onClose}
              className="w-12 h-12 glass-card rounded-full flex items-center justify-center hover:glass-card-hover transition-all duration-300"
            >
              <svg
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              {project.technologies.map((tech, index) => (
                <span
                  key={tech}
                  className="px-4 py-2 glass rounded-full text-sm font-semibold text-gray-700 hover:glass-card-hover hover:text-blue-700 transition-all duration-300"
                >
                  {tech}
                </span>
              ))}
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">주요 기능</h3>
            </div>
            <div className="space-y-4">
              {project.features.map((feature, index) => (
                <div key={index} className="flex items-start gap-4">
                  <div className="w-8 h-8 glass rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">트러블슈팅</h3>
            </div>

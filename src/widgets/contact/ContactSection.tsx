    ...
    <section id="contact" className="relative section-padding overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-12 sm:mb-16 max-w-5xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 responsive-grid mb-12 sm:mb-16">
          ...
          <div className="relative bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-12 overflow-hidden">
            {/* 배경 패턴 */}
